...
const Cookies = () => {
  ...
  return (
    <section id="cookies">
      ...
      <p>La presente política de cookies tiene por finalidad informarle de manera clara y precisa sobre las cookies que se utilizan en la página web de la Biblioteca del I.E.S. HLANZ.</p>
      ...
      <p>Según quién sea la entidad que gestione el dominio desde dónde se envían las cookies y se traten los datos que se obtengan, se pueden distinguir dos tipos: cookies propias y cookies de terceros.
      ...
      <p>A continuación se identifican las cookies que están siendo utilizadas en este portal así como su tipología y función:
      ...
      <p>Usted puede restringir, bloquear o borrar las cookies de la Biblioteca del I.E.S. HLANZ o cualquier otra página web utilizando su navegador. En cada navegador la operativa es diferente, la función de "Ayuda" le mostrará cómo hacerlo.</p>
